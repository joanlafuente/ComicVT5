...
"""
Dataset class thought for doing an experiment with the VL-T5 
model on the text-cloze task, in which we do not provide a 
task prefix to the model. This class is specific to the use 
of a single feature vector for each panel.
