...
from src.models.modeling_vlt5_head_CLS import VLT5
from pyats.datastructures import AttrDict

"""
In this file we define the model based on the modified VLT5 
which has a classification head and CLS token.
"""
...
class TextClozeImageTextVLT5Model(VLT5):
    ...
    def run(self, *args, **kwargs):
        ...
        # print(input_ids.size(), vis_feats.size(), vis_pos.size(), img_order_ids.size(), obj_order_ids.size())
        logits = self(
            input_ids=input_ids,
        ...
        # print("Pred", output.prediction)
        # print("Label", kwargs["labels"])
        return output
