...
if __name__ == "__main__":
    ...
    # Load the resnet50 model fine-tuned with SimCLR
    feature_extractor = Model_SimCLR().to("cuda")
    profile(feature_extractor, inputs=(torch.randn(1, 3, 200, 200).to("cuda"),))
    feature_extractor.load_state_dict(torch.load("/home/jlafuente/ComicsQA/Models/test_model_12_epochs_730k_img_finetuneing.pt"))
    ...
    import pickle
    with open(os.path.join(out_dir, 'Sim_CLR_panels_features.pkl'), 'wb') as f:
